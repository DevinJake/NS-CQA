...
def getTestDataset():
    ...
    fwTestQ = open('../../data/auto_QA_data/nomask_test/FINAL_test.question', 'w', encoding="UTF-8")
    fwTestA = open('../../data/auto_QA_data/nomask_test/FINAL_test.action', 'w', encoding="UTF-8")
...
def getSampleTestDataset():
    fwTestQ = open('../../data/auto_QA_data/nomask_test/SAMPLE_FINAL_test.question', 'w', encoding="UTF-8")
    fwTestA = open('../../data/auto_QA_data/nomask_test/SAMPLE_FINAL_test.action', 'w', encoding="UTF-8")
    with open("../../data/auto_QA_data/CSQA_ANNOTATIONS_test.json", 'r', encoding="UTF-8") as load_f:
        count = 1
        train_action_string_list, test_action_string_list, train_question_string_list, test_question_string_list = list(), list(), list(), list()
        dict_list = list()
