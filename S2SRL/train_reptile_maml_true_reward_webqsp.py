...
if __name__ == "__main__":
    ...
    sys.argv = ['train_reptile_maml_true_reward.py', '-l=../data/saves/webqsp/rl_even_adaptive_1%_att=1/pre_bleu_0.928_06.dat',
                '-n=maml_att=0_newdata2k_reptile', '--cuda', '-s=5', '-a=0', '--att=1', '--lstm=1', '--fast-lr=1e-4',
