...
if __name__ == "__main__":
    ...
    sys.argv = ['train_scst_cher_webqsp.py', '--cuda',
                '-l=../data/webqsp_saves/pretrained/epoch_030_0.995_0.966.dat',
                '-n=rl_cher', '-s=5', '-a=0', '--att=0', '--lstm=1',
                # '--int',
